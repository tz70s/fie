...
class RSLimitedHost(CPULimitedHost):
    ...
    def setMem(self, mem=0):
        ...
        if mem != 0:
            ...
            # 1MB
            mega = 1024*1024
            self.cgroupSet(resource='memory',
                           param='limit_in_bytes', value=mem*mega)
    ...
    def setMemSW(self, memsw=0):
        ...
        if memsw != 0:
            ...
            mega = 1024*1024
            self.cgroupSet(resource='memory',
                           param='memsw.limit_in_bytes', value=memsw*mega)
    ...
    def setSwappiness(self, swappiness=None):
        ...
        if swappiness != None and swappiness >= 0 and swappiness <= 100:
            self.cgroupSet(resource='memory',
                           param='swappiness', value=swappiness)
